...
本项目包含 **30 余个循序渐进的实战示例**（持续更新中）。建议按编号顺序学习：
...
| 11 | `11_i2c_bus_probe_01` | I2C 总线扫描探测 — 遍历 0x03~0x77 查找所有从机设备 |
| 13 | `13_st7789_lcd_01` | SPI 接口 LCD 屏幕驱动与显示 |
| 13 | `13_02_SE_first_lcd_color` | SPI LCD 进阶 — 彩色显示（颜色填充与图形绘制） |
| 13 | `13_03_lcd_image` | SPI LCD 进阶 — 图片解码与显示 |
| 13 | `13_LEDnAHT30_ESP_TIMER` | 综合应用 — LED + AHT30 温湿度采集 + ESP 定时器联动 |
