...
本项目（截止于2026年4月6日，逐步更新）目前包含 12 个循序渐进的实战示例：
...
| **10** | 🌈 RGB WS2812 | LEDC模块 PWM 输出，实现呼吸灯效果 |
| **11** | 🌡️ I2C 传感器 | AHT30温湿度传感器数据采集 |
| **12** | 🖥️ LCD 显示 | SPI接口LCD屏幕驱动与显示 |
